...
from src.schemas.question_schemas import QuizSubmission,ResultResponse,QuizCreate,Single_subject,Total_subject
...
@app.post("/users/quiz_submit", response_model=ResultResponse)
...
@app.get("/api/graph_data",response_model=Total_subject)
def graph_data():
    pass
